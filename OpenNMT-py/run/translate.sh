...
declare -a modelnames=("fren.transformer.softmax") #("fren.transformer.vmf.long" "fren.transformer.vmf.5" "fren.transformer.vmf.6" "fren.transformer.vmf.7") # "fren.transformer.vmf.1" "fren.transformer.vmf.2" "fren.transformer.vmf.3" "fren.transformer.vmf.4")
BS=1
for modelname in "${modelnames[@]}"; do
    ...
    for i in 2000 4000 6000 8000 10000 12000 14000 16000 18000 20000 22000 24000 26000 28000 30000 32000 34000 36000 38000 40000; do
        ...
        ./evaluate.sh logs/$modelname/step_${i}_pred.bs$BS.en ../../kumarvon2018-data/fren/tst201516.en en >> logs/$modelname/bleus8.txt
    done
done

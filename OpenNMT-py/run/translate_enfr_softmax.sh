...
declare -a modelnames=("enfr.transformer") # "fren.transformer.vmf.3") #("fren.transformer.vmf.long" "fren.transformer.vmf.5" "fren.transformer.vmf.6" "fren.transformer.vmf.7") # "fren.transformer.vmf.1" "fren.transformer.vmf.2" "fren.transformer.vmf.3" "fren.transformer.vmf.4")
for modelname in "${modelnames[@]}"; do
    echo $modelname
    for BS in 1 2 3 4 5; do
        rm logs/$modelname/bleus_bs$BS.txt
        for i in {10000..70000..10000}; do
            ...
            ./evaluate.sh logs/$modelname/step_${i}_pred.bs$BS.fr ../../kumarvon2018-data/fren/tst201516.fr fr >> logs/$modelname/bleus_bs$BS.txt
        done
    done
done

...
def process_one_shard(corpus_params, params):
    ...
    feat_vocab_counter = [
        defaultdict(Counter) for _ in fields["tgt"]
    ]  # not used in non-tagged cases
    ...
    if corpus_type == "train" and existing_fields is None:
        for ex in dataset.examples:
            ...
            if (
                opt.multi_task and len(fields["tgt"].fields) > 1
            ):  # in case of multitask learning and multiple features, create feat x main_vocab counter
